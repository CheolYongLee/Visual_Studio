...
// ImageProcessing2.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CImageProcessing2App 개체입니다.

CImageProcessingApp theApp;


// CImageProcessing2App 초기화
...
BOOL CImageProcessingApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_ImageProcessing2TYPE,
...
//	ON_UPDATE_COMMAND_UI(ID_DOWN_SAMPLING, &CAboutDlg::OnUpdateDownSampling)
ON_COMMAND(ID_DOWN_SAMPLING, &CAboutDlg::OnDownSampling)
END_MESSAGE_MAP()
...
// CImageProcessing2App 사용자 지정 로드/저장 방법
...
//void CAboutDlg::OnUpdateDownSampling(CCmdUI* pCmdUI)
//{
